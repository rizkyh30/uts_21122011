...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('/about'); ?>" target="_blank">About</a>
            </li>
            <li class="menu-item hidden"><a href="<?= base_url('/education'); ?>" target="_blank">Education</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang di Website KY</h1>

        <h2>ini digunakan untuk menujukan kompetensi saya dalam mengguanakan framework HMVC dalam pengembangan aplikasi web serta mengelola source code menggunakan sistem kontrol versi GIT</h2>
